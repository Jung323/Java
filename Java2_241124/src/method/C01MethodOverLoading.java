...
// 오버로드된 메서드는 서로 다른 접근 제어자, 다른 예외를 던질 수 있으면 정적 또는 비정적일 수 있음 
// → private, public 등의 접근 제어자로 구분 X
// → static, non-static으로 구분 X
...
public class C01MethodOverLoading {
	public static void main(String[] args) {
		Simple obj = new Simple();
		obj.sum(10,20);
		obj.sum(10.1, 10.2);
		obj.sum(10, 20, 30);
		int result = obj.sum("HELLO WORLD", 10,20);
